...
const footerColumns = [
  ...
  },
  {
    title: "Teach with Us",
    links: [
      { label: "Become a Teacher", href: "/portal" },
      { label: "Teacher Help Center", href: "/help" },
      { label: "Teacher Rules & Requirements", href: "/help" },
    ],
  },
  {
    title: "Shop",
    links: [
      { label: "Gift Memberships", href: "/courses" },
  ...
  return (
    <footer className="bg-black text-white">
      <div className="mx-auto max-w-6xl px-4 py-16">
        ...
        <div className="mt-12 border-t border-emerald-400 pt-8">
          <p className="text-center text-xs font-semibold text-white/60">
            &copy; SkillUp, {new Date().getFullYear()} · Help · Privacy · Terms · Your Privacy Choices · Notice to CA Residents
          </p>
          ...
          <div className="mt-6 flex flex-col items-center justify-between gap-6 sm:flex-row">
            ...
            <div className="flex items-center gap-3">
              <span className="text-xs font-semibold text-white/70">English</span>
              <select className="rounded-md border border-white/15 bg-white/5 px-3 py-2 text-xs font-semibold text-white/90 focus:outline-none focus:ring-2 focus:ring-white/40">
